import $toISOString, {implementation} from '../src/to-iso-string-x';

[implementation, $toISOString].forEach((toISOString, testNum) => {
  describe(`toISOString ${testNum}`, function() {
    let negativeDate;
    ...
    it('should return correct dates', function() {
      expect.assertions(25); // Safari 5.1.5 "1969-12-31T23:59:59.-01Z"
