 ...
 */
"use strict";var isWorking,nativeToISOString="function"==typeof Date.prototype.toISOString&&Date.prototype.toISOString;if(nativeToISOString){var attempt=_dereq_("attempt-x"),res=attempt.call(new Date(0),nativeToISOString);(isWorking=!1===res.threw&&"1970-01-01T00:00:00.000Z"===res.value)&&(isWorking=!1===(res=attempt.call(new Date(-621987552e5),nativeToISOString)).threw&&res.value.indexOf("-000001")>-1),isWorking&&(isWorking=!1===(res=attempt.call(new Date(-1),nativeToISOString)).threw&&"1969-12-31T23:59:59.999Z"===res.value)}var $toISOString;if(isWorking)$toISOString=function toISOString(date){return nativeToISOString.call(date)};else{var isDate=_dereq_("is-date-object"),padStart=_dereq_("string-pad-start-x"),map=_dereq_("array-map-x"),arraySlice=_dereq_("array-slice-x"),join=Array.prototype.join;$toISOString=function toISOString(date){if(!1===isDate(date))throw new TypeError("toISOString called on incompatible receiver.");if(!1===isFinite(date)||!1===isFinite(date.getTime()))throw new RangeError("toISOString called on non-finite value.");var year=date.getUTCFullYear(),month=date.getUTCMonth();year+=month/12>>0;var sign,parts=[(month=(month%12+12)%12)+1,date.getUTCDate(),date.getUTCHours(),date.getUTCMinutes(),date.getUTCSeconds()];year=(sign=year<0?"-":year>9999?"+":"")+padStart(Math.abs(year),sign?6:4,"0");var result=map(parts,function _mapper(item){return padStart(item,2,"0")}),dateStr=year+"-"+join.call(arraySlice(result,0,2),"-"),msStr=padStart(date.getUTCMilliseconds(date),3,"0");return dateStr+"T"+(join.call(arraySlice(result,2),":")+"."+msStr)+"Z"}}module.exports=$toISOString},{"array-map-x":3,"array-slice-x":4,"attempt-x":6,"is-date-object":12,"string-pad-start-x":29}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":15,"is-primitive":18,"safe-to-string-x":27}],6:[function(_dereq_,module,exports){/**
 ...
 * @module attempt-x
 */
"use strict";var arrayLikeSlice=_dereq_("array-like-slice-x");module.exports=function attempt(fn){try{return{threw:!1,value:fn.apply(this,arrayLikeSlice(arguments,1))}}catch(e){return{threw:!0,value:e}}}},{"array-like-slice-x":2}],7:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":16}],15:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":16,"to-number-x":32}],23:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],24:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":39,"white-space-x":41}],25:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":19}],26:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":17}],27:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function toObject(value){return Object(requireObjectCoercible(value))}},{"require-object-coercible-x":26}],34:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":21,"validate.io-undefined":40}],36:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":20}],37:[function(_dereq_,module,exports){/**
