 ...
 * @module array-map-x
 */
"use strict";var toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x"),some=_dereq_("array-some-x"),toLength=_dereq_("to-length-x");module.exports=function map(array,callBack){var object=toObject(array);assertIsFunction(callBack);var result=[];result.length=toLength(object.length);var args=[object,function _wrapped(item,idx,obj){result[idx]=callBack.call(this,item,idx,obj)}];return arguments.length>2&&(args[2]=arguments[2]),some.apply(void 0,args),result}},{"array-some-x":3,"assert-is-function-x":4,"to-length-x":52,"to-object-x":53}],3:[function(_dereq_,module,exports){/**
